...
import com.ho.service.MemberService;
...
public class MemberController {
	...
	public String mailCheckGET(String email) throws Exception{
		...
		//이메일 보내기
		String setFrom = "hoho_428@naver.com";
		String toMail = email;
		String title = "회원가입 인증 이메일 입니다.";
		String content = "홈페이지를 방문해주셔서 감사합니다." + "<br><br>" + "인증 번호는 " + checkNum + " 입니다." + 
	...
	//로그아웃
		...
		public void logoutGET(HttpServletRequest request) throws Exception{
			...
			log.info("logoutGET메서드 진입, 비동기 로그아웃 메서드 진입");
