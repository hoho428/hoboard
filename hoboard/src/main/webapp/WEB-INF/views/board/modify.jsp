...
<div class="wrapper">
	<div class="wrap">
			...
			<div class="intro">
				<div class="intro1">Process rather than result</div>
			...
			<div class="content_wrap">
				...
				<div class="input_wrap">
					<div id="content_left">
						...
						<label id="bar">|</label>
						<label>수정일 : </label>
						<input id="uddate" readonly="readonly" value='<fmt:formatDate pattern="yyyy년 MM월 dd일" value="${pageInfo.uddate}"/>'>
					</div>
				...
				<div class="input_wrap_textarea">
					<textarea id="modify_content" rows="3" name="content"><c:out value="${pageInfo.content}"></c:out></textarea>
				</div>
				<div class="input_wrap">
					<input type="hidden" readonly="readonly" value='<fmt:formatDate pattern="yyyy년 MM월 dd일" value="${pageInfo.regdate}"/>'>
				</div>
